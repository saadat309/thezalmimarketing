...
const featureImage = "/ch sajid.jpg";
...
export default function FeaturedFeature() {
  const whatsappUrl = "https://wa.me/923218446496?text=" + encodeURIComponent("Hi Ch. Sajid Mahmood, I read your feature and would like to consult regarding real estate opportunities.");
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="grid items-center gap-8 sm:gap-12 lg:grid-cols-[minmax(0,0.85fr)_minmax(0,1fr)] lg:gap-16 text-center lg:text-left"
        >
          {/* Press clipping */}
          <figure className="group relative mx-auto w-full max-w-sm sm:max-w-md lg:mx-0">
            ...
            >
              <img
                src={featureImage}
                alt={`${feature.publication} feature on Ch. Sajid Mahmood, CEO of The Zalmi Marketing`}
                loading="lazy"
                width={1080}
                height={1350}
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="flex items-center justify-center lg:justify-start gap-4">
              ...
              <span className="text-xs sm:text-sm tracking-wide text-amber-400">In the press</span>
            </div>

            <h2
              id="press-feature-heading"
              className="mt-4 sm:mt-5 font-display text-2xl sm:text-3xl lg:text-[2.75rem] leading-tight text-white tracking-tight"
            >
              {feature.headline}
            </h2>
            ...
            <p className="mt-4 max-w-xl text-sm sm:text-base leading-relaxed text-slate-400 font-light">{feature.body}</p>
